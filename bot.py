    ...
    if user.merge_mode == 4:
        ...
        if rmess.video or rmess.document:
            ...
            if file_name is None:
                await m.reply("File name not found; goto @NUMBER03ANURAG")
                return
...
🔰 ᴏᴡɴᴇʀ ᴄᴀɴ ʙʀᴏᴀᴅᴄᴀsᴛ ᴍᴇssᴀɢᴇ ᴛᴏ ᴀʟʟ ᴜsᴇʀs
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("👨‍💻Developer👨‍💻", url="https://t.me/NUMBER03ANURAG")],
                [
                    InlineKeyboardButton(
                        "🏘Source Code🏘", url="https://github.com/Na dunga"
                    ),
                    InlineKeyboardButton(
    ...
    try:
        with userBot:
            userBot.send_message(
                ...
                text="Bot booted with Premium Account,\n\n  Thanks for using <a href='https://github.com'>this bot</a>",
